...
<script type="text/javascript">
	$(function() {
		...
		/* 한 페이지에 보여줄 레크드 수 변경될 때마다 처리 이벤트 */
				...
				<table summary="검색">
					...
					<tr>
						<td id="btd1"><label>검색조건</label> <select id="search"
							name="search">
								<option value="b_title">전체</option>
			...
			<table summary="게시판리스트">
				...
				<thead>
					<tr>
						...
						<th>글제목</th>
						<th data-value="b_data" class="order">작성일 <c:choose>
								<c:when
				...
				<tbody id="list">
					...
					<c:choose>
						...
						<c:otherwise>
							<tr>
								<td colspan="4" class="tac">등록된 게시물이 존재 하지 않습니다.</td>
							</tr>
						</c:otherwise>
					</c:choose>
				</tbody>
