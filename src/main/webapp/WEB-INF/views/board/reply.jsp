...
<script type="text/javascript">
var replyNum, message = "작성시 입력한 비밀번호를 입력해 주세요.",
...
$(function() {
	...
	$("#replyInsert").click(function() {
		//작성자 이름에 대한 입력여부 검사
		if(!chkData("#r_name","이름을")) return;
		else if(!chkData("#r_pwd","비밀번호를")) return;
	...
	$(document).on("click", ".pwdResetBut", function() {
		...
		//$(this).parents().parent().removeClass("overLayer");
